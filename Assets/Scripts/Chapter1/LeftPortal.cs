...
public class LeftPortal : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        leftPortalCamera.targetTexture = viewTexture;
    ...
    public void UpdateCamera(Camera playerCamera)
    {
        ...
        leftPortalCamera.transform.rotation = finalRotation;

        // 4️ 카메라 시야각 및 클리핑 조정
        leftPortalCamera.fieldOfView = playerCamera.fieldOfView;
    ...
    private void TeleportPlayer(GameObject player)
    {
        ...
        {
            // 1. 포탈 통과 전 CharacterControlsler 비활성화
            ...
            {
                // 최대 단계를 넘지 않도록 제한
                if (portalManager.portalStage < 2)
                {
